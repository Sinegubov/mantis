...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        driver = self.driver
        driver.get("http://localhost/mantisbt-1.2.20/manage_proj_create_page.php")
        driver.find_element_by_name("name").click()
        driver.find_element_by_name("name").clear()
        driver.find_element_by_name("name").send_keys("New name")
        Select(driver.find_element_by_name("status")).select_by_visible_text("stable")
        ...
        driver.find_element_by_name("description").send_keys("asdasdasdasdasdasdasd")
